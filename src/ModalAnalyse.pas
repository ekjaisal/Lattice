...
var
  ...
  AttributeString, Linker, Condition, ColumnName, OpSelection, AttributeValue, OpStr, AttributeType, ValueFirst, ValueSecond: String;
  IsNumeric: Boolean;
begin
  Result := '';
  ...
  AttributeString := '';
  for Index := 0 to High(FAttributeCacheArray) do
  begin
    if FAttributeCacheArray[Index].OperatorVal = '' then Continue;
    ColumnName := FAttributeCacheArray[Index].Key;
    AttributeType := FAttributeCacheArray[Index].AttributeType;
    IsNumeric := AttributeType = 'Numeric';
    OpSelection := FAttributeCacheArray[Index].OperatorVal;
    AttributeValue := FAttributeCacheArray[Index].FilterValue;
